...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>SIAJAR | SEAMOLEC LMS</title>
        ...
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon57.png" sizes="57x57">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon72.png" sizes="72x72">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon76.png" sizes="76x76">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon114.png" sizes="114x114">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon120.png" sizes="120x120">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon144.png" sizes="144x144">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon152.png" sizes="152x152">
        <link rel="apple-touch-icon" href="assets/img/pro-ui/icon180.png" sizes="180x180">
        <!-- END Icons -->

        <!-- Stylesheets -->
        <!-- Bootstrap is included in its original form, unaltered -->
        <link rel="stylesheet" href="assets/css/lib/pro-ui/bootstrap.css">

        <!-- Related styles of various icon packs and plugins -->
        <link rel="stylesheet" href="assets/css/lib/pro-ui/plugins.css">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="assets/css/lib/pro-ui/main.css">

        <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
        <link rel="stylesheet" href="assets/css/lib/pro-ui/themes.css">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) -->
        <script src="assets/js/lib/pro-ui/modernizr.min.js"></script>
    </head>
    <body>
        <!-- Page Container -->
        ...
        <div id="page-container">
            ...
            <header>
                <div class="container">
                    ...
                    <a href="index.php" class="site-logo">
                        <!-- <img src="assets/img/pro-ui/lms_logo.png"> -->
                        <strong>SIAJAR </strong>LMS
                    </a>
                    <!-- Site Logo -->
            ...
            <!-- Intro -->
            <section class="site-section site-section-light site-section-top parallax-image" style="background-image: url('assets/img/pro-ui/placeholders/parallax/photo1.jpg');">
                <div class="container">
                    <h1 class="text-center animation-slideDown hidden-xs"><strong>LMS</strong></h1>
                    <h2 class="text-center animation-slideUp push hidden-xs">Learing Management System</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 text-center push">
                        <img src="assets/img/pro-ui/placeholders/screenshots/LearningOnlineLaptop.png" alt="Promo" class="img-responsive center-block animation-fadeIn">
                    </div>
                </div>
                <div class="site-block text-center">
                    <a href="http://goo.gl/TDOSuC" class="btn btn-lg btn-success"><i class="fa fa-sign-in"></i> Masuk</a>
                    <a href="http://demo.pixelcave.com/proui" class="btn btn-lg btn-primary"><i class="fa fa-pencil-square-o"></i> Daftar</a>
                </div>
            </section>
            <!-- END Intro -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            <img src="assets/img/pro-ui/placeholders/screenshots/promo_desktop_left.png" alt="Promo #1" class="img-responsive">
                        </div>
                        <div class="col-sm-6 col-md-5 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <h3 class="h2 site-heading site-heading-promo"><strong>Apa Itu</strong> SIAJAR ???</h3>
                            <p class="promo-content">SIAJAR is a professional, modern and solid foundation for your next awesome project. It comes packed with great features that you will love. <a href="features.html">Learn More..</a></p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- Quick Stats -->
            <section class="site-content site-section parallax-image" style="background-image: url('assets/img/pro-ui/placeholders/parallax/photo2.jpg');">
                <div class="container">
                    <!-- Stats Row -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <img src="assets/img/pro-ui/placeholders/screenshots/promo_desktop_right.png" alt="Promo #2" class="img-responsive">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- Testimonials -->
            <section class="site-content site-section site-section-light parallax-image" style="background-image: url('assets/img/pro-ui/placeholders/parallax/photo3.jpg');">
                <div class="container">
                    ...
                    <div id="testimonials-carousel" class="carousel slide carousel-html" data-ride="carousel" data-interval="4000">
                        ...
                        <div class="carousel-inner text-center">
                            <div class="active item">
                                <p>
                                    <img src="assets/img/pro-ui/placeholders/avatars/avatar12.jpg" alt="Avatar" class="img-circle">
                                </p>
                            ...
                            <div class="item">
                                <p>
                                    <img src="assets/img/pro-ui/placeholders/avatars/avatar7.jpg" alt="Avatar" class="img-circle">
                                </p>
                                <blockquote class="no-symbol">
                            ...
                            <div class="item">
                                <p>
                                    <img src="assets/img/pro-ui/placeholders/avatars/avatar9.jpg" alt="Avatar" class="img-circle">
                                </p>
                                <blockquote class="no-symbol">
            ...
            <section class="site-content site-section site-slide-content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            <img src="assets/img/pro-ui/placeholders/screenshots/promo_tablet.png" alt="Promo #3" class="img-responsive">
                        </div>
                        <div class="col-sm-6 col-md-5 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
            ...
            <!-- Sign Up Action -->
            <section class="site-content site-section site-section-light parallax-image" style="background-image: url('assets/img/pro-ui/placeholders/parallax/photo4.jpg');">
                <div class="container">
            ...
            <section class="site-content site-section site-slide-content">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <img src="assets/img/pro-ui/placeholders/screenshots/promo_mobile.png" alt="Promo #4" class="img-responsive">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <script src="assets/js/lib/pro-ui/jquery.min.js"></script>
        <script src="assets/js/lib/pro-ui/bootstrap.min.js"></script>
        <script src="assets/js/lib/pro-ui/plugins.js"></script>
        <script src="assets/js/lib/pro-ui/app.js"></script>
    </body>
</html>
