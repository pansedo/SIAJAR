...
(function(window, document, $, undefined) {
    ...
    var _messages = {
        ...
        'INTEGER': '$ harus angka saja.',
        'NUMERIC': '$ harus huruf saja.',
        'MIXED': '$ harus kombinasi huruf dan juga angka (tanpa karakter sepsial).',
        'NAME': '$ tidak boleh ada karakter spesial.',
        'NOSPACE': '$ tidak boleh ada spasi.',
        'TRIM': '$ must not start or end with space character.',
        'DATE': '$ is not a valid with format YYYY-MM-DD.',
        'EMAIL': '$ penulisan tidak benar.',
        'URL': '$ tidak benar.',
        'PHONE': '$ penulisan no.telp tidak benar.',
        '<': '$ harus lebih kecil dari % karakter.',
        '<=': '$ harus lebih kecil atau sama dengan % karakter.',
        '>': '$ harus lebih besar dari % karakter.',
        '>=': '$ harus lebih besar atau sama dengan % karakter.',
        '==': '$ harus sama dengan %',
